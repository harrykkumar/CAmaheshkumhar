...
const routes: Routes = [
  ...
  },
  {
   ...
   // loadChildren: './login/login.module#LoginModule'
    loadChildren: async () => {
      const { LoginModule } = 
      await import('./login/login.module');
      return LoginModule;
    }
  },
  {
  ...
  //  loadChildren: '../app/start/user-modules/user-modules.module#UserModulesModule',
    loadChildren: async () => {
      const { UserModulesModule } = 
      await import('../app/start/user-modules/user-modules.module');
  ...
  },
  {
   ...
   //loadChildren: './start/user-organizations/user-organizations.module#UserOrganizationsModule',
    loadChildren: async () => {
      const { UserOrganizationsModule } = 
      await import('./start/user-organizations/user-organizations.module');
  ...
  },
  {
    ...
    loadChildren: async () => {
      const { UserFinancialYearsModule } = 
      await import('./start/user-financial-years/user-financial-years.module');
  ...
  },
  {
   ...
   // loadChildren: './start/user-branches/user-branches.module#UserBranchesModule',
    loadChildren: async () => {
      const { UserBranchesModule } = 
      await import('./start/user-branches/user-branches.module');
  ...
  },
  {
    ...
    loadChildren: async () => {
      const { NoOrganizationModule } = 
      await import('./start/no-organization/no-organization.module');
  ...
  },
  {
   ...
   // loadChildren: './settings/settings.module#SettingsModule',
    loadChildren: async () => {
      ...
      await import('./settings/settings.module');
  ...
  },
  {
    ...
    loadChildren: async () => {
      const { TransactionNumberModule } = 
      await import('./shared/transaction-number/transaction-number.module');
