...
@Component({
  selector: 'app-add-followup-detail',
  templateUrl: './add-followup-detail.component.html',
  styleUrls: ['./add-followup-detail.component.css']
})
export class AddFollowupDetailComponent implements OnInit {
  ...
  openModal() {
    this.commonService.openModal('add_followup_detail');
  }
  ...
  closePopUp(data?) {
    this.commonService.closeModal('add_followup_detail')
  ...
  preparePayload() {
    ...
    return {
      ...
      "Revenue": this.model.companyRevenue ? this.model.companyRevenue : 0,
