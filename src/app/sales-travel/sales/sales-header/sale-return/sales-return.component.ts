...
export class SalesReturnComponent {
  ...
  getAvailableCurrency () {
    return this.commonService.getSaleReturnSetting()
  }
  ...
  private salesTravelParams (): SalesReturnTourism {
    ...
    this.ReturnBillDate = this.gs.clientToSqlDateFormat(this.ReturnBillDate, this.clientDateFormat)
    ...
    const salesTravelElement = {
      obj: {
        ...
        ReturnBillDate: this.ReturnBillDate,
