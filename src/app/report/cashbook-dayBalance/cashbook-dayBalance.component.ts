...
@Component({
  ...
  templateUrl: './cashbook-dayBalance.component.html',
  styleUrls: ['./cashbook-dayBalance.component.css']
})
export class CashbookDayBalanceComponent implements OnInit, AfterViewInit {
  cashBook: any = {}
  ...
  getCashBookData = () => {
    ...
    this._commonService.getCashBook(data).pipe(
      takeUntil(this.unSubscribe$)
    ).subscribe((response: any) => {
