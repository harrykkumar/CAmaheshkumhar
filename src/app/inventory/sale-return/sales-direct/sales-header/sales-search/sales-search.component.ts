...
export class SalesSearchComponent {
  ...
  constructor (private _commonService: CommonService ,private formBuilder: FormBuilder, private _ledgerServices: VendorServices,
  ...
  getSuplier () {
    ...
    this._ledgerServices.getVendor(UIConstant.CUSTOMER_GLID, '').subscribe(data => {
  ...
  search () {
    if (this.searchForm.valid) {
      ...
      this._commonService.setSearchQueryParamsStr(queryStr)
    }
  }
