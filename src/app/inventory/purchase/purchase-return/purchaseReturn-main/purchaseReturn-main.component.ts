...
declare const _: any
@Component({
  selector: 'app-purchaseReturn-main',
  templateUrl: './purchaseReturn-main.component.html'
})
export class PurchaseReturnMainComponent {
  title: string
  sub: Subscription
  ...
  // itemAttbute:any
    ...
    let _self = this
    _self.commonService.printPurchaseReturn(id).subscribe(data => {
      if (data.Code === UIConstant.THOUSAND) {
